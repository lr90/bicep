...
//@[38:38) [BCP113 (Error)] An empty indexer is not allowed. Specify a valid expression. ||
//@[40:40) [BCP113 (Error)] An empty indexer is not allowed. Specify a valid expression. ||
...
//@[55:55) [BCP113 (Error)] An empty indexer is not allowed. Specify a valid expression. ||
//@[60:60) [BCP113 (Error)] An empty indexer is not allowed. Specify a valid expression. ||
